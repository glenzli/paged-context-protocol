...
> **Deprecated historical protocol.** This document is no longer the current
> PCP specification. See [README.md](README.md) for the rationale and
> [../../PROTOCOL-en.md](../../PROTOCOL-en.md) for the successor draft.
